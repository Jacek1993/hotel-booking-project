          ...
          {this.state.cartItems.map((item, i) => {
              ...
              <div className={classes.details}>
                <CardContent className={classes.content}>
                  <Link to={`/user/room/${item.slug}`}><Typography type="title" component="h3" className={classes.productTitle} color="primary">{item.description[0]}</Typography></Link>
                  <div>
                    <Typography type="subheading" component="h3" className={classes.price} color="primary">$ {item.pricing.sale}</Typography>
